...
public class GenerateExampleSettings {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        for (Setting system : androidSystemSettingList) {
            if (PortalRomSettings.System.isLegacySetting(system.getKey())) {
                defaultSettings.add(system);
            }
        }

        for (Setting secure : androidSecureSettingList) {
            if (PortalRomSettings.Secure.isLegacySetting(secure.getKey())) {
                defaultSettings.add(secure);
            }
        }

        for (Setting global : androidGlobalSettingList) {
            if (PortalRomSettings.Global.isLegacySetting(global.getKey())) {
        ...
        out.write("# Settings which are to be moved to PortalRomSettings\n");
        out.write("# Automatically generated by " +
                "portalrom-sdk/host/migration/src/GenerateExampleSettings"
