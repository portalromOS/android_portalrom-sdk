 ...
 */
package org.portalrom.platform.internal.display;
...
public class DisplayHardwareController extends LiveDisplayFeature {
    ...
    private final PortalRomHardwareManager mHardware;
    ...
    private static final Uri DISPLAY_AUTO_CONTRAST =
            PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_AUTO_CONTRAST);
    private static final Uri DISPLAY_COLOR_ADJUSTMENT =
            PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_COLOR_ADJUSTMENT);
    private static final Uri DISPLAY_COLOR_ENHANCE =
            PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_COLOR_ENHANCE);
    private static final Uri DISPLAY_CABC =
            PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_CABC);
    private static final Uri DISPLAY_READING_MODE =
            PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_READING_MODE);
    private static final Uri DISPLAY_ANTI_FLICKER =
            PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_ANTI_FLICKER);
    ...
    public DisplayHardwareController(Context context, Handler handler) {
        ...
        mUseCABC = mHardware
                .isSupported(PortalRomHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT);
        mDefaultCABC = mContext.getResources().getBoolean(
                org.portalrom.platform.internal.R.bool.config_defaultCABC);

        mUseColorEnhancement = mHardware
                .isSupported(PortalRomHardwareManager.FEATURE_COLOR_ENHANCEMENT);
        mDefaultColorEnhancement = mContext.getResources().getBoolean(
                org.portalrom.platform.internal.R.bool.config_defaultColorEnhancement);

        mUseAutoContrast = mHardware
                .isSupported(PortalRomHardwareManager.FEATURE_AUTO_CONTRAST);
        mDefaultAutoContrast = mContext.getResources().getBoolean(
                org.portalrom.platform.internal.R.bool.config_defaultAutoContrast);

        mUseColorAdjustment = mHardware
                .isSupported(PortalRomHardwareManager.FEATURE_DISPLAY_COLOR_CALIBRATION);

        mUseDisplayModes = mHardware
                .isSupported(PortalRomHardwareManager.FEATURE_DISPLAY_MODES);

        mUseReaderMode = mHardware
                .isSupported(PortalRomHardwareManager.FEATURE_READING_ENHANCEMENT);

        mUseAntiFlicker = mHardware
                .isSupported(PortalRomHardwareManager.FEATURE_ANTI_FLICKER);
        mDefaultAntiFlicker = mContext.getResources().getBoolean(
                org.portalrom.platform.internal.R.bool.config_defaultAntiFlicker);
    ...
    private void updateAutoContrast() {
        ...
        mHardware.set(PortalRomHardwareManager.FEATURE_AUTO_CONTRAST, isAutoContrastEnabled());
    }
    ...
    private void updateColorEnhancement() {
        ...
        mHardware.set(PortalRomHardwareManager.FEATURE_COLOR_ENHANCEMENT,
    ...
    private void updateCABCMode() {
        ...
        mHardware.set(PortalRomHardwareManager.FEATURE_ADAPTIVE_BACKLIGHT, isCABCEnabled());
    }
    ...
    private void updateAntiFlicker() {
        ...
        mHardware.set(PortalRomHardwareManager.FEATURE_ANTI_FLICKER, isAntiFlickerEnabled());
    }
    ...
    boolean isAutoContrastEnabled() {
        return mUseAutoContrast &&
                getBoolean(PortalRomSettings.System.DISPLAY_AUTO_CONTRAST, mDefaultAutoContrast);
    }
    ...
    boolean setAutoContrastEnabled(boolean enabled) {
        ...
        putBoolean(PortalRomSettings.System.DISPLAY_AUTO_CONTRAST, enabled);
        return true;
    }

    boolean isCABCEnabled() {
        return mUseCABC &&
                getBoolean(PortalRomSettings.System.DISPLAY_CABC, mDefaultCABC);
    }
    ...
    boolean setCABCEnabled(boolean enabled) {
        ...
        putBoolean(PortalRomSettings.System.DISPLAY_CABC, enabled);
        return true;
    }

    boolean isColorEnhancementEnabled() {
        return mUseColorEnhancement &&
                getBoolean(PortalRomSettings.System.DISPLAY_COLOR_ENHANCE,
    ...
    boolean setColorEnhancementEnabled(boolean enabled) {
        ...
        putBoolean(PortalRomSettings.System.DISPLAY_COLOR_ENHANCE, enabled);
        return true;
    }
    ...
    float[] getColorAdjustment() {
        ...
        if (!parseColorAdjustment(getString(PortalRomSettings.System.DISPLAY_COLOR_ADJUSTMENT), cur)) {
    ...
    private void saveColorAdjustmentString(final float[] adj) {
        ...
        putString(PortalRomSettings.System.DISPLAY_COLOR_ADJUSTMENT, sb.toString());
    }
    ...
    boolean isAntiFlickerEnabled() {
        return mUseAntiFlicker &&
                getBoolean(PortalRomSettings.System.DISPLAY_ANTI_FLICKER, mDefaultAntiFlicker);
    }
    ...
    boolean setAntiFlickerEnabled(boolean enabled) {
        ...
        putBoolean(PortalRomSettings.System.DISPLAY_ANTI_FLICKER, enabled);
        return true;
    }
}
