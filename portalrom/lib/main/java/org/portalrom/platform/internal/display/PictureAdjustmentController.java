...
public class PictureAdjustmentController extends LiveDisplayFeature {
    ...
    public PictureAdjustmentController(Context context, Handler handler) {
        ...
        mHardware = PortalRomHardwareManager.getInstance(context);
        mHasDisplayModes = mHardware.isSupported(PortalRomHardwareManager.FEATURE_DISPLAY_MODES);

        boolean usePA = mHardware.isSupported(PortalRomHardwareManager.FEATURE_PICTURE_ADJUSTMENT);
        if (usePA) {
    ...
    public void onStart() {
        ...
        registerSettings(
                PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_PICTURE_ADJUSTMENT));
    }
    ...
    private SparseArray<HSIC> unpackPreference() {
        ...
        String pref = getString(PortalRomSettings.System.DISPLAY_PICTURE_ADJUSTMENT);
        if (pref != null) {
    ...
    private void packPreference(final SparseArray<HSIC> modes) {
        ...
        putString(PortalRomSettings.System.DISPLAY_PICTURE_ADJUSTMENT, sb.toString());
    }
