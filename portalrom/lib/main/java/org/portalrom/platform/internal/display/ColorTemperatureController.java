...
import org.portalrom.platform.internal.display.TwilightTracker.TwilightState;
...
import static portalrom.hardware.LiveDisplayManager.MODE_AUTO;
import static portalrom.hardware.LiveDisplayManager.MODE_DAY;
import static portalrom.hardware.LiveDisplayManager.MODE_NIGHT;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    private static final Uri DISPLAY_TEMPERATURE_DAY =
            PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_TEMPERATURE_DAY);
    private static final Uri DISPLAY_TEMPERATURE_NIGHT =
            PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_TEMPERATURE_NIGHT);
    ...
    public ColorTemperatureController(Context context,
        ...
        mUseColorBalance = mHardware
                .isSupported(PortalRomHardwareManager.FEATURE_COLOR_BALANCE);
        ...
        mDefaultDayTemperature = mContext.getResources().getInteger(
                org.portalrom.platform.internal.R.integer.config_dayColorTemperature);
        mDefaultNightTemperature = mContext.getResources().getInteger(
                org.portalrom.platform.internal.R.integer.config_nightColorTemperature);

        mColorTemperatureRange = Range.create(
                mContext.getResources().getInteger(
                        org.portalrom.platform.internal.R.integer.config_minColorTemperature),
                mContext.getResources().getInteger(
                        org.portalrom.platform.internal.R.integer.config_maxColorTemperature));

        mColorBalanceCurve = org.portalrom.internal.util.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = org.portalrom.internal.util.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
    ...
    int getDayColorTemperature() {
        return getInt(PortalRomSettings.System.DISPLAY_TEMPERATURE_DAY,
                mDefaultDayTemperature);
    }

    void setDayColorTemperature(int temperature) {
        putInt(PortalRomSettings.System.DISPLAY_TEMPERATURE_DAY, temperature);
    }

    int getNightColorTemperature() {
        return getInt(PortalRomSettings.System.DISPLAY_TEMPERATURE_NIGHT,
                mDefaultNightTemperature);
    }

    void setNightColorTemperature(int temperature) {
        putInt(PortalRomSettings.System.DISPLAY_TEMPERATURE_NIGHT, temperature);
    }
