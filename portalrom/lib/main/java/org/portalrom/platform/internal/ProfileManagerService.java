...
/** @hide */
public class ProfileManagerService extends PortalRomSystemService {

    private static final String TAG = "PortalRomProfileService";
    ...
    private class ProfilesObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            int state = PortalRomSettings.System.getInt(mContext.getContentResolver(),
    ...
    public String getFeatureDeclaration() {
        return PortalRomContextConstants.Features.PROFILES;
    }
    ...
    public void onStart() {
        ...
        mWildcardGroup = new NotificationGroup(
                mContext.getString(org.portalrom.platform.internal.R.string.wildcardProfile),
                org.portalrom.platform.internal.R.string.wildcardProfile,
                mWildcardUUID);
        ...
        if (mContext.getPackageManager().hasSystemFeature(
            ...
            publishBinderService(PortalRomContextConstants.PORTALROM_PROFILE_SERVICE, mService);
        } else {
            Log.wtf(TAG, "PortalRom profile service started by system server but feature xml not" +
    ...
    private void enforceChangePermissions() {
        mContext.enforceCallingOrSelfPermission(
                portalrom.platform.Manifest.permission.MODIFY_PROFILES,
    ...
    private void initialiseStructure() throws XmlPullParserException, IOException {
        XmlResourceParser xml = mContext.getResources().getXml(
                org.portalrom.platform.internal.R.xml.profile_default);
        try {
