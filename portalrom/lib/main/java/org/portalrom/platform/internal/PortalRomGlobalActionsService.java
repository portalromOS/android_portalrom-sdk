...
import static portalrom.providers.PortalRomSettings.Secure.POWER_MENU_ACTIONS;
import static portalrom.providers.PortalRomSettings.Secure.getStringForUser;
import static portalrom.providers.PortalRomSettings.Secure.putStringForUser;

import static org.portalrom.internal.util.PowerMenuConstants.GLOBAL_ACTION_KEY_BUGREPORT;
import static org.portalrom.internal.util.PowerMenuConstants.GLOBAL_ACTION_KEY_LOCKDOWN;
...
import portalrom.app.IPortalRomGlobalActions;

import org.portalrom.internal.util.PowerMenuConstants;
 ...
 * @hide
 */
public class PortalRomGlobalActionsService extends PortalRomSystemService {
    ...
    public PortalRomGlobalActionsService(Context context) {
        super(context);
    ...
    public String getFeatureDeclaration() {
        return PortalRomContextConstants.Features.GLOBAL_ACTIONS;
    }

    @Override
    public void onStart() {
        publishBinderService(PortalRomContextConstants.PORTALROM_GLOBAL_ACTIONS_SERVICE, mBinder);
    }
    ...
    private final IBinder mBinder = new IPortalRomGlobalActions.Stub() {
