...
import org.portalrom.platform.internal.common.UserContentObserver;
import org.portalrom.platform.internal.display.TwilightTracker.TwilightListener;
 ...
 */
public class LiveDisplayService extends PortalRomSystemService {
    ...
    public String getFeatureDeclaration() {
        return PortalRomContextConstants.Features.LIVEDISPLAY;
    }
    ...
    @Override
    public void onStart() {
        publishBinderService(PortalRomContextConstants.PORTALROM_LIVEDISPLAY_SERVICE, mBinder);
    }
    ...
    public void onBootPhase(int phase) {
        if (phase == PHASE_BOOT_COMPLETED) {
            ...
            int defaultMode = mContext.getResources().getInteger(
                    org.portalrom.platform.internal.R.integer.config_defaultLiveDisplayMode);
            ...
            Intent intent = new Intent(portalrom.content.Intent.ACTION_INITIALIZE_LIVEDISPLAY);
    ...
    private final IBinder mBinder = new ILiveDisplayService.Stub() {
        ...
        public boolean setMode(int mode) {
            mContext.enforceCallingOrSelfPermission(
                    portalrom.platform.Manifest.permission.MANAGE_LIVEDISPLAY, null);
            if (!mConfig.hasModeSupport()) {
                return false;
            }
    ...
    private final class ModeObserver extends UserContentObserver {
        ...
        private final Uri MODE_SETTING =
                PortalRomSettings.System.getUriFor(PortalRomSettings.System.DISPLAY_TEMPERATURE_MODE);
        ...
        int getMode() {
            return getInt(PortalRomSettings.System.DISPLAY_TEMPERATURE_MODE,
                    mConfig.getDefaultMode());
        }

        boolean setMode(int mode) {
            if (mConfig.hasFeature(mode) && mode >= MODE_FIRST && mode <= MODE_LAST) {
                putInt(PortalRomSettings.System.DISPLAY_TEMPERATURE_MODE, mode);
    ...
    private int getSunsetCounter() {
        ...
        return PortalRomSettings.System.getIntForUser(mContext.getContentResolver(),
    ...
    private void nudge() {
        ...
        if (counter == 0) {
            ...
            final Intent intent = new Intent(PortalRomSettings.ACTION_LIVEDISPLAY_SETTINGS);
            PendingIntent result = PendingIntent.getActivity(mContext, 0, intent,
                    PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
            Notification.Builder builder = new Notification.Builder(mContext)
                    .setContentTitle(mContext.getResources().getString(
                            org.portalrom.platform.internal.R.string.live_display_title))
                    .setContentText(mContext.getResources().getString(
                            org.portalrom.platform.internal.R.string.live_display_hint))
                    .setSmallIcon(org.portalrom.platform.internal.R.drawable.ic_livedisplay_notif)
