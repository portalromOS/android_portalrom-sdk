...
public class PortalRomSystemSettingDropDownPreference extends SelfRemovingDropDownPreference {
    public PortalRomSystemSettingDropDownPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public PortalRomSystemSettingDropDownPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
